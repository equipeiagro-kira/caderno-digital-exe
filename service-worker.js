const CACHE_NAME = "exa-caderno-v20";

const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./public/vendor/leaflet/leaflet.css?v=20",
  "./public/vendor/leaflet/leaflet.js?v=20",
  ...
  "./src/styles.css?v=20",
  "./src/data.js?v=20",
  "./src/protocols-data.js?v=20",
  "./src/compaction-data.js?v=20",
  "./src/app.js?v=20",
