const CACHE_NAME = "exa-caderno-v28";

const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./public/vendor/leaflet/leaflet.css?v=28",
  "./public/vendor/leaflet/leaflet.js?v=28",
  ...
  "./src/styles.css?v=28",
  "./src/data.js?v=28",
  "./src/protocols-data.js?v=28",
  "./src/compaction-data.js?v=28",
  "./src/diaporthe-data.js?v=28",
  "./src/app.js?v=28",
