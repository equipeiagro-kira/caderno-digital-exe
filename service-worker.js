const CACHE_NAME = "exa-caderno-v24";

const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./public/vendor/leaflet/leaflet.css?v=24",
  "./public/vendor/leaflet/leaflet.js?v=24",
  ...
  "./src/styles.css?v=24",
  "./src/data.js?v=24",
  "./src/protocols-data.js?v=24",
  "./src/compaction-data.js?v=24",
  "./src/app.js?v=24",
